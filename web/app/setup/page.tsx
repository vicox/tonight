 ...
 *
 * Renders nothing while `PREREQUISITES` is empty, which is the current state:
 * the walkthrough was run and nothing had to be arranged before step 1. See the
 * list itself for what would go in it and where such a sentence has to come from.
 */

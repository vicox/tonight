...
Tonight project instructions · version a13b627c · replace these when tonight.movie shows a different version.
`;

/** The digest in the last line of the text above, for the website to show. */
export const PROJECT_INSTRUCTIONS_VERSION = "a13b627c";
